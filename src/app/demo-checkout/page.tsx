...
export default function DemoCheckoutPage() {
  ...
  const handlePay = () => {
    // демо-оплата — моментальный успех
  ...
  async function submitQuestion() {
    try {
      ...
      // просто отправляем на твой существующий /api/lead, чтобы не ломать поток
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                <div className="rounded-xl border border-[#eadfcf] bg-white/70 p-5">
                  ...
                  <div className="mt-2 text-[#6b5a43] text-sm">Доступ к материалам, живые разборы, коммьюнити и сопровождение наставника.</div>
                  <ul className="mt-4 space-y-2 text-[#4a3e2c]">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-2"><Check className="h-5 w-5 mt-[2px]" />{t}</li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="mt-6 rounded-xl border border-[#eadfcf] bg-white/70 p-5">
                  ...
                  <div className="grid gap-3 mt-3">
                    ...
                    <Button onClick={submitQuestion} disabled={sending}
              ...
              <div>
                <div className="rounded-xl border border-[#eadfcf] bg-white/70 p-5">
                  ...
                  <div className="mt-4 flex items-center gap-2 text-[#6b5a43] text-sm">
