...
const MENU_POST = process.env.NEXT_PUBLIC_MENU_POST || "#";

// Карта курсов (название + цена в ₽). Тексты внутри карточки — единые «продающие», как на скрине.
...
// Универсальные тексты «как на скрине»
const SUBTITLE =
  "Доступ к материалам, живые разборы и сопровождение наставника";
const BENEFITS = [
  ...
  return (
    <div className="min-h-screen" style={{ background: "#f8f5ef" }}>
      <div className="mx-auto max-w-[1080px] px-6 py-12">
        ...
        {/* Карточка: ПК — широкая трехколоночная сетка, мобилка — как на скрине */}
        <article
        ...
        >
          <div className="p-5 lg:p-8 grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            {/* Левая (контент) — занимает 2/3 на десктопе */}
            ...
            {/* Правая (цена + CTA) — как на скрине; на мобилке тоже в одну строку */}
